...
export default function Month(props) {
  const { months, currentMonth: month, currentYear: year, styles, onSelectMonth, textStyle, minDate, maxDate } = props;
  ...
  const monthOutOfRange = monthIsAfterMax || monthIsBeforeMin || monthIsDisabled;
