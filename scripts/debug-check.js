...
const criticalFiles = [
  ...
  'app.json',
  'metro.config.js',
  'src/infrastructure/services/NavigationService.ts',
  'themes/Colors.js',
  'themes/Fonts.js',
  'themes/Metrics.js',
...
try {
  ...
  if (reactVersion && reactVersion.startsWith('19.')) {
    console.log('  WARNING: React 19.x is very new and may have compatibility issues');
...
try {
  ...
  if (fontsFile.includes('SF Pro') && !fontsFile.includes('Platform')) {
    console.log('  WARNING: SF Pro font detected without Platform check');
    ...
    console.log('ℹ  Font configuration appears safe');
  }
